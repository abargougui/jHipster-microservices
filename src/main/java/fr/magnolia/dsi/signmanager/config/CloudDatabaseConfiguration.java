package fr.magnolia.dsi.signmanager.config;
...
@Configuration
@EnableMongoRepositories("fr.magnolia.dsi.signmanager.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.magnolia.dsi.signmanager.config.dbmigrations");
