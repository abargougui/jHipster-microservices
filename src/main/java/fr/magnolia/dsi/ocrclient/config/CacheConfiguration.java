package fr.magnolia.dsi.ocrclient.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ocrclient");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ocrclient");
        ...
        config.getMapConfigs().put("fr.magnolia.dsi.ocrclient.domain.*", initializeDomainMapConfig(jHipsterProperties));
