...
/**
 * REST controller for managing {@link fr.magnolia.dsi.signaturemanager.domain.SignRequest}.
 */
@RestController
@RequestMapping("/api")
public class SignRequestResource {
    ...
    private static final String ENTITY_NAME = "signaturemanagerSignRequest";
