package fr.magnolia.dsi.signaturemanager.config;
...
@Configuration
@EnableMongoRepositories("fr.magnolia.dsi.signaturemanager.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.magnolia.dsi.signaturemanager.config.dbmigrations");
